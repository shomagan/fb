...
*/    unsigned int fb00038_var_size(unsigned char type) {
    switch(type){
    case(0):
        return sizeof(fb00038_IN_type);
    case(1):
        return sizeof(fb00038_VAR_type);
    case(2):
        return sizeof(fb00038_OUT_type);
    default:
        return 0;
    }
}
